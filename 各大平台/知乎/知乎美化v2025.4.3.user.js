...
// @resource     zhihu-beautify https://update.greasyfork.org.cn/scripts/523346/zhihu-beautify.user.css
...
// @grant        unsafeWindow
// @run-at       document-end
// @downloadURL https://update.greasyfork.org.cn/scripts/402808/%E7%9F%A5%E4%B9%8E%E7%BE%8E%E5%8C%96.user.js
// @updateURL https://update.greasyfork.org.cn/scripts/402808/%E7%9F%A5%E4%B9%8E%E7%BE%8E%E5%8C%96.meta.js
// ==/UserScript==
...
function question() {
    ...
    //问题编辑时间参考：https://greasyfork.org.cn/zh-CN/scripts/398195
...
function pin() {
    ...
    */
    ...
    //发布时间置顶
    if (publishTop == 1 && $(".ContentItem-meta").find(".ContentItem-time:not(.css-18wtfyc)").length == 0) {
...
function addLocalCSS() {
    ...
    @namespace   zhihu
    @license     MIT
    @downloadURL https://update.greasyfork.org.cn/scripts/523346/zhihu-beautify.user.css
    @updateURL https://update.greasyfork.org.cn/scripts/523346/zhihu-beautify.meta.css
    ==/UserStyle== */
    ...
    */
    ...
    /*固定导航栏-大菜单*/
    html[data-theme=dark] .css-133xqjo{
        color: #d3d3d3!important;
    }
    html[data-theme=dark] .css-133xqjo:hover{
        color:#0084ff!important;
        background:#1772f60f!important;
    }
    /*固定导航栏-小菜单*/
    ...
    html[data-theme="dark"] .css-194iiw5{
        background: #191b1f!important;
        border-bottom: 1px solid #444!important;
    }
    /*好物推荐-订单信息表头*/
...
//设置框样式参考https://greasyfork.org.cn/zh-CN/scripts/37988
